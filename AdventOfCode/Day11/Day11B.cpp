...
Day11B::Day11B() :
    output(0),
    map(100, std::vector<int>(50, 0)),
    paintingCnt(100, std::vector<int>(100, 0)),
    x(50),
    y(25),
    direction('U')
{
...
void Day11B::ReadInput()
{
    ...
    //The rest of the panels are still black, but it looks like the robot was expecting to start on a white 
    //panel, not a black one.
    input = 1;
}

void Day11B::ProcessData()
{
...
long long Day11B::RunProgram(std::vector<long long>& programCode)
{
